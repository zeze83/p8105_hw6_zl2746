...
```
    ...
    ##  1            1     0.922          8.13 1.02  -0.00616    NaN   
    ##  2            2     0.915          8.13 1.01   0.00339     -5.67
    ##  3            3     0.933          7.73 1.04  -0.00592    NaN   
    ##  4            4     0.932          7.82 1.04  -0.00791    NaN   
    ##  5            5     0.932          8.03 1.03  -0.0102     NaN   
    ##  6            6     0.916          7.76 1.02  -0.000261   NaN   
    ##  7            7     0.907          8.08 1.01   0.00113     -6.77
    ##  8            8     0.895          8.13 0.992  0.000245    -8.32
    ##  9            9     0.898          7.93 1.01  -0.00585    NaN   
    ## 10           10     0.917          8.09 1.01  -0.00397    NaN   
    ## # ℹ 4,990 more rows
...
**There is only 0.3308 of dataset can be used for log(beta1 \* beta2).**
...
``` r
# variable selection by backward stepwise
