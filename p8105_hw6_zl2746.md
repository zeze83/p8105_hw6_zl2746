...
homicide <- read_csv("homicide-data.csv") |>
  ...
  mutate(solved = ifelse(disposition %in% c("Closed without arrest", "Open/No arrest"), "1","0"),
...
```
    ...
    ## # ℹ 5 more variables: city_state <chr>, lat <dbl>, lon <dbl>,
    ## #   disposition <chr>, solved <chr>
...
```
    ...
    ##  1            1     0.924          8.16 1.02  -0.00629    NaN   
    ##  2            2     0.916          8.39 1.01  -0.00371    NaN   
    ##  3            3     0.912          7.96 1.00   0.00632     -5.06
    ##  4            4     0.934          7.69 1.05  -0.00608    NaN   
    ##  5            5     0.896          8.46 0.969  0.00483     -5.36
    ##  6            6     0.923          7.94 1.03  -0.000928   NaN   
    ##  7            7     0.940          7.29 1.06  -0.00516    NaN   
    ##  8            8     0.943          7.75 1.05  -0.00651    NaN   
    ##  9            9     0.905          8.37 0.980  0.00297     -5.84
    ## 10           10     0.910          8.13 1.01   0.00122     -6.70
    ## # ℹ 4,990 more rows
...
<img src="p8105_hw6_zl2746_files/figure-gfm/unnamed-chunk-5-2.png" width="90%" />
...
<img src="p8105_hw6_zl2746_files/figure-gfm/unnamed-chunk-5-3.png" width="90%" />
...
<img src="p8105_hw6_zl2746_files/figure-gfm/unnamed-chunk-5-4.png" width="90%" />
...
<img src="p8105_hw6_zl2746_files/figure-gfm/unnamed-chunk-8-1.png" width="90%" />
...
<img src="p8105_hw6_zl2746_files/figure-gfm/unnamed-chunk-12-1.png" width="90%" />
